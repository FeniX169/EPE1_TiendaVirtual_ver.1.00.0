<%-- 
    Document   : index
    Created on : 17-ago-2024, 21:20:18
...
<html>
    <head>
        ...
        <title>TechSpot tienda virtual</title>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>TechSpot</i></a>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <div class="form-group">
                                            <label>Rut</label>
                                            <input type="text" maxlength="8" name="txtdni" class="form-control" placeholder="12345678-9">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input type="text" name="txtdire" class="form-control" placeholder="Tech spot, maipu">
                                        </div>
                                        <div class="form-group">
                                            <label>Email address</label>
                                            <input type="email" name="txtemail" class="form-control" placeholder="email@example.com">
